function [SE,YP] = rmse_FPCA_2(X,Xt,A,At,M,Mt)
...
p = 14; % % the number of control points
...
for i = 1:1:25
    ...
    theta0 = 1e-5*ones(1,q); delta0 = 1e-3; % initialization
    iterations = 100;
    tic;
    [model] = optimization_2(X_train, score_train, @corrGaussian, theta0, delta0, iterations);
    t = toc;
