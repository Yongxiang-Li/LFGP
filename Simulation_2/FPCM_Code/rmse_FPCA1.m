function SE = rmse_FPCA1(X,Xt,A,At,M,Mt)
...
for i = 1:1:20
    ...
    theta0 = 1e-5*ones(1,q); delta0 = 1e-1; % initialization
    iterations = 100;
    
    [model] = optimization1(X_train, score_train, @corrGaussian, theta0, delta0, iterations);
